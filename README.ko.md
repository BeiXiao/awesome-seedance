...
| Prompt | Input |
|--------|-------|
| 소녀가 우아하게 빨래를 널고, 다 널은 후에는 다시 통에서 다른 옷을 꺼내 힘차게 흔듭니다. | <img src="https://r2.getseedance.com/seedance-cases/001-girl-hanging-laundry/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 그림 속 인물은 마음이 불안해한 표정을 지으며 눈을 좌우로 움직이며 그림틀 밖으로 몸을내밀었다. 그는 빠르게 손을 그림틀 밖으로 뻗어 콜라를 들고 한 모금 마셨더니 만족스러운 표정을 지었다. 그때 발자국 소리가 들려오자 그림 속 인물은 급히 콜라를 제자리에 놓았다. 이때 한 서부 카우보이가 컵에 든 콜라를 집어 들고 걸어갔다. 마지막으로 카메라가 앞으로 밀려 화면은 천천히纯黑 배경이 되고, 오직顶光만罐装 콜라를 비추었다.画面最下方에는 예술적인 자막과 나레이션이出现：“宜口可乐，不可不尝！” | <img src="https://r2.getseedance.com/seedance-cases/002-painting-character-steals-coke/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 카메라는 살짝 멀어지며 거리 전경을 드러내고 여주인공을 따라 움직입니다. 바람이 여주인공의 치마를 흔들어주며, 그녀는 19세기 런던 거리를 걷고 있습니다. 여주인공이 걷다가 오른쪽 거리에서 증기차가 달려와 그녀의 옆을 빠르게 지나가자, 바람이 그녀의 치마를 불어올립니다. 여주인공은 깜짝 놀라며 두 손으로 치마를 아래로 눌러 잡습니다. 배경 음향으로는 보행자 발소리, 사람들의 소리, 자동차 소리 등이 들립니다. | <img src="https://r2.getseedance.com/seedance-cases/003-victorian-london-steam-carriage/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 카메라는 검은 옷을 입은 남자를 따라 빠르게 도망가는 모습을 촬영합니다. 뒤에는한 무리의 사람들이 쫓아오고 있으며, 카메라는 측면에서 따라가며 촬영합니다. 남자는 당황하여 길가의 과일 가게를 넘어뜨리고 일어나 다시 도망가며,군중의 당황한 소리가 들립니다. | <img src="https://r2.getseedance.com/seedance-cases/004-chase-scene-fruit-stall/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 남자@사진1 퇴근 후 피곤하게 복도를 걷다 걸음이 느려지고 마침내 집 문 앞에 멈춥니다. 얼굴을 크게 잡아클로즈업 촬영을 통해 남자가 숨을 깊게 들이쉬며 기분을 다잡고 부정적인 감정을 숨기고편안해지는 모습을 보여줍니다. 그런 다음 열쇠를 찾아서 잠금장치에 넣고 집에 들어가면 작은 딸과 애완견이기쁘게 달려와 포옹으로 맞이합니다. 실내는매우 따뜻하며 전체 과정에 자연스러운 대화가 이어집니다. | <img src="https://r2.getseedance.com/seedance-cases/005-father-returns-home-daughter/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| @비디오1의 여성을 희극 화단으로 교체하고, 장면은 정교한 무대 위에 설정해 주세요. @비디오1의 카메라 운용과 전환 효과를 참고하여, 카메라로 인물의 동작을 매칭시키고 극치의 무대 미학을 구현하여 시각적 충격력을 강화해 주세요. | <video src="https://r2.getseedance.com/seedance-cases/006-opera-actress-stage-performance/Video1.mp4" controls width="320"></video> |
...
| Prompt | Input |
|--------|-------|
| @사진1의 여배우를 주체로 하고, @동영상1의 카메라 운영 방식을 참고하여 리듬감 있는 푸시, 풀, 패닝, 트래킹을 적용하고, 여배우의 동작도 @동영상1에 나오는 여자의 춤 동작을 참고하여 무대에서 활력 넘치게 공연하도록 해주세요 | <img src="https://r2.getseedance.com/seedance-cases/014-dancer-stage-performance/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 흑백 수묵화 스타일로, @사진1의 인물을 참고하고 @비디오1의 특효와 동작을 적용하여 수묵 태극권功夫를 연출해주세요 | <img src="https://r2.getseedance.com/seedance-cases/021-ink-style-tai-chi-performance/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 검은 배경으로 시작하며, 비디오1의 입자 효과와 질감을 참고하여 금색 물들인 모래 알갱이가 화면 왼쪽에서飘올라오면서 오른쪽으로 덮어지며, 비디오1의 입자 흩어지는 효과와 이미지1의 글씨체를 참고하여 화면 중앙에 글자가 점차 나타납니다. | <img src="https://r2.getseedance.com/seedance-cases/024-golden-sand-particle-title/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| @그림1의 인물 참고@동영상1의 동작과 표정 변화를 참고하여 라면을 먹는 추상적인 행위를 표현해주세요 | <img src="https://r2.getseedance.com/seedance-cases/025-abstract-noodle-eating-scene/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| @이미지1의专题片의 분镜头脚本을 참고하고, @이미지1의 분镜,景别,运镜,画面 및文案을 참고하여 "어린 시절의 사계절"이라는治愈系 15초 프롤로그를创作해주세요 | <img src="https://r2.getseedance.com/seedance-cases/027-childhood-seasons-healing-intro/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 10초 앞으로 연장해 주세요. 따뜻한 오후 햇빛 속에서, 카메라는 먼저 바람에 살랑거리는 거리 모퉁이의 그림자막에서 시작해 천천히 벽기슨에 솟아난 몇 송이 작은 데이지까지 내려갑니다. 이어 화면에는 주인공의 빨간 발판화가 나타나며, 그는 거리 꽃가게 앞에蹲(쭈그려 앉)아서 큰 한 송이 해바라기를 품에 안으며 웃고 있습니다. 꽃잎이 그의 흰 티셔츠에 스치고 지납니다. 그는 스케이트보드를 밟고 돌아섰을 때, 꽃가게 주인이 웃으면서 "꽃잎 날아가지 말고 조심해!"라고 외치고, 그는 주인에게 손을 흔든 후에야滑行(미끄러져 나)갑니다. 몇 조각의 금색 꽃잎은 이미 먼저 꽃다발에서 벗어나 스케이트보드 판 위에 떨어졌습니다. | <video src="https://r2.getseedance.com/seedance-cases/032-skateboard-sunflower-street-scene/Video1.mp4" controls width="320"></video> |
...
| Prompt | Input |
|--------|-------|
| "고양이와 강아지의 투吐방"에서의 투吐 대화를 토크쇼 공연에 맞게 감정이 풍부하게 만들어주세요 | <img src="https://r2.getseedance.com/seedance-cases/035-cat-dog-talk-show-dialogue/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 유豫극(옥극) 전막 단락 《찰미안(잘라버린 미인의 안)》의 반주가 울리자 왼쪽의 검은 옷을 입은 포증(包拯)이 오른쪽의 빨간 옷을 입은 진세미(陳世美)를 가리키며 이를 갈며 유豫극을 부르며 외쳤다. "칼이 꼬리에 꽂히듯, 진실한 증거가 있는데 너가招供(자백)하지 않겠느냐?" 진세미는 눈동자를 왼쪽 오른쪽으로 돌리며 위급한 조치책을 찾아 허둥지둥해하며 얼굴색이 심히 창백해졌다. 이때 화면 밖에서 유豫극 단각(旦角)의 연백(念白)이 들려왔다. "잠깐!" 포증과 진세미는 함께 화면 오른쪽을 바라보았다. | <img src="https://r2.getseedance.com/seedance-cases/036-yuju-opera-zha-mei-case/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 15초 분량의 MV 영상을 생성하세요. 키워드: 견고한 구도 / 부드러운推拉 / 낮은 각도의 영웅적 느낌 / 다큐멘터리적이면서 고급스러움 A 초광각으로 establishing shot을 잡고, 낮은 카메라 각도로 약간 올려 촬영합니다. 절벽의 흙길과 복고 풍 여행차는 화면 하단 1/3을 차지하고, 멀리 바다와 지평선으로 공간을 확장시킵니다. 저녁 노을의 측면逆光이 먼지 입자를 통과하는 볼륨 라이트, 영화 같은 구도, 실제 필름 그레인, 미풍에 흔들리는 옷깃입니다. | <img src="https://r2.getseedance.com/seedance-cases/037-cliff-road-vintage-car-mv/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 고정镜头. 서 있는 근육질의 남자(팀장)가 주먹을 쥐고 팔을 휘두르며 스페인어로 말한다. "삼분 후 돌격!" 칼을 든 자는 칼을 갑주에 넣고, 금발 팀원은 총기를 점검하고, 녹색 머리 팀원은 전술 손전등을 단단히 쥐고 있다. 흑인 팀원이 동료의 어깨를搭肩하고 스페인어로 묻는다. "측면 포위?" 팀장은 고개를 끄덕이며 스페인어로 말한다. "예전 규칙대로, 생포해 심문하도록." 전원이 침착해지고, 장비가 부딪히는 소리 속에서 전술 수세를 완료하며,默契 있게 일어서서 모두 긴장해 있다. 왼쪽에 있는 두 명의 남자도 서둘러 일어나 싸울 준비를 한다. | <img src="https://r2.getseedance.com/seedance-cases/039-tactical-team-raid-preparation/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| 과학 홍보 스타일과 음색을 사용하여 그림 1의 내용을 연출하십시오. 내용은 오공이 화염산을 지나기 위해 취운운산으로 가서 철선공주에게 파초선을 빌리는情节을 포함합니다. 철선공주는 붉은아이가 오공에게降服되어 관음님의 제자가 된 후 모자가 분리되었기 때문에 선을 빌려주지 않고 복수를 하려고 합니다. 오공이 착하게 권했지만 소용없어서 두 사람은 곧 다툼을 벌이는 작은 이야기를 설명하십시오. | <img src="https://r2.getseedance.com/seedance-cases/042-journey-west-fan-borrowing-story/Image1.png" alt="Image1.png" width="320"> |
...
| Prompt | Input |
|--------|-------|
| @동영상1의 줄거리를 뒤엎어라. 남자의 눈빛이 부드럽게부터 순간 차갑고 가혹하게 변하며, 루스가毫无防备한 순간,猛地여자를 다리 위에서 밖으로 밀어 물 속으로 넣는다. 그 동작은干脆利落하며 미리 계획된 결연함을 담고 있어丝毫犹豫도 없었고, 원래의 깊은 감정의 인물 설정을彻底히 뒤엎어 버렸다. 여자가 물 속으로 추락하는 순간 비명은 없었고,难以置信한 눈빛만 있었으며, 그녀는抬头해 남자에게嘶吼하며 말했다. "넌 처음부터 날 속였어!" 남자는 다리 위에 서서 얼굴에 음森한 미소를 지으며 수면을 향해 낮게 말했다. "이것은 너가 우리 가족에게 지은 빚이야." | <video src="https://r2.getseedance.com/seedance-cases/048-bridge-betrayal-water-fall/Video1.mp4" controls width="320"></video> |
